...
const tempMembers = [
  ...
  { member_seq: 3, party_seq: 1, user_seq: 3, userName: '이민찬', imgNo: 3, cost: 5400, status: true, receive: true, isLeader: true, createdAt: "2024-07-06T01:49:00" },
          ...
          Object.keys(groupedMembers).map(month => (
            <div key={month}>
              ...
              {groupedMembers[month].map(member => (
                <SendMoneyCard key={member.member_seq} {...member} />
              ))}
            </div>
          ))
        )}
