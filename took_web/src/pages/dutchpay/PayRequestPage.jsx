function PayRequestPage () {
    ...
    return(<div className="flex flex-col items-center px-20 py-20 text-4xl text-main bg-white max-w-[360px]">
        <div className="mt-20">
        ...
        />
        <div className="mt-20 font-extrabold">8,777<span>  원</span></div>
