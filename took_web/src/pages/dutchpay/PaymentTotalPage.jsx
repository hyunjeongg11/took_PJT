...
function PaymentTotalPage() {
    // 모든 차수의 총 금액 계산
    const totalSum = Object.values(temp_data).reduce((sum, phase) => sum + phase.totalAmount, 0);
                ...
                {Object.keys(temp_data).map((phaseKey) => {
                    ...
                    return (
                        <div key={phaseKey} className="flex flex-col items-center">
                            ...
                            <div className="flex animate-semijump flex-wrap items-center justify-center gap-2 mt-3 relative" style={{ width: '60px', height: '60px' }}>
