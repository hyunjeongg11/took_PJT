...
const CheckExpectedCost = ({ isOpen, onClose, destinations, tempUser, totalExpectedCost }) => {
      ...
      <div className="bg-white w-80 py-6 px-4 rounded-xl shadow-lg">
        ...
        <div className="mb-4 px-2">
          {destinations.map((item, index) => {
            const userCost = totalExpectedCost?.users.find((user) => user.userSeq === item.userId)?.cost || 0;
            return (
