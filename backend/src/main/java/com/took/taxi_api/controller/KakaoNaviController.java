...
public class KakaoNaviController {
     ...
     */
    @PostMapping("/expect")
    public ResponseEntity<ExpectCostResponse> calculateCost(@RequestBody ExpectCostRequest request) {
    ...
    public ResponseEntity<AllExpectCostResponse> calculateAllCost(@RequestBody AllExpectCostRequest request) {
